...
from transformers.trainer import Trainer as TransformersTrainer

# Define ALL_LAYERNORM_LAYERS since it's removed in newer transformers versions
...
class BaseTrainer(TransformersTrainer):
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            optimizer_cls, optimizer_kwargs = TransformersTrainer.get_optimizer_cls_and_kwargs(
                self.args
            )
