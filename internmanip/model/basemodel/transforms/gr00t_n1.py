...
from internmanip.dataset.schema import DatasetMetadata, EmbodimentTag, EMBODIMENT_TAG_MAPPING
...
# class DefaultDataCollatorGR00TN1(DataCollatorMixin):
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
#         self.processor = EagleProcessor()

#     def __call__(self, features: List[Dict[str, Any]], return_tensors=None) -> Dict[str, Any]:
#         return collate_gr00t_n1(features, self.processor)

# # class DefaultDataCollatorGR00TN15(DataCollatorMixin):
# #     def __init__(self, processor, *args, **kwargs):
# #         super().__init__(*args, **kwargs)
# #         self.processor = processor

# #     def __call__(self, features: List[Dict[str, Any]], return_tensors=None) -> Dict[str, Any]:
# #         return collate(features, self.processor)
...
#         return collate_gr00t_n15(features, self.eagle_processor)
...
class GR00TTransform(InvertibleModalityTransform):
    ...
    def apply_single(self, data: dict) -> dict:
        ...
        images = self._prepare_video(data) # tensor
...
class GR00TTransform_15(InvertibleModalityTransform):
