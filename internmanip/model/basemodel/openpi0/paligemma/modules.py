...
class GemmaMLP(nn.Module):
    def __init__(self, config, item_config, use_quantize=False, use_lora=False):
        super().__init__()
        self.config = config
        self.hidden_size = item_config.hidden_size
        self.intermediate_size = item_config.intermediate_size
