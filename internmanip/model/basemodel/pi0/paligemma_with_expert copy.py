...
class PaliGemmaWithExpertModel(PreTrainedModel):
    ...
    def forward(
        ...
        models = [self.paligemma.language_model, self.paligemma.language_model]
        ...
        tmp_embs = torch.cat(inputs_embeds, dim=1)
        import os
        if 'DEBUG' in os.environ:
            hidden_states = self.paligemma.language_model(inputs_embeds=tmp_embs, output_hidden_states=True)['hidden_states']
            return (0, hidden_states[-1]), 0
