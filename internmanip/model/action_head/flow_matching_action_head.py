...
class FlowmatchingActionHead(nn.Module):
    ...
    def calc_loss(self, outputs: BatchFeature, action_input: BatchFeature) -> BatchFeature:
        """
        Calculate the loss.
        """
        action_mask = action_input.action_mask
...
@dataclass
class FlowmatchingActionHeadConfig_1_5(PretrainedConfig):
...
class FlowmatchingActionHead_1_5(nn.Module):
    config_class = FlowmatchingActionHeadConfig
    supports_gradient_checkpointing = True
