...
from internmanip.dataset.schema import DatasetMetadata, RotationType, StateActionMetadata
from internmanip.dataset.transform.base import InvertibleModalityTransform, ModalityTransform
...
class StateActionTransform(InvertibleModalityTransform):
    ...
    def set_metadata(self, dataset_metadata: DatasetMetadata):
        ...
        for key in self.normalization_modes:
            ...
            ), f'{modality}.{state_key} shape={getattr(modality_metadata, modality)[state_key].shape}'
